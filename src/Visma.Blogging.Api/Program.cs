...
builder.Services.AddSingleton<IOutboxWriter>(provider => provider.GetRequiredService<MongoOutboxStore>());
...
builder.Services.AddSingleton<IPostCommandStore>(provider => provider.GetRequiredService<MongoBlogStore>());
